...
sitemap.write_text(re.sub(r'(<url><loc>https://mortalshell2guide.xyz/collectibles/tarstones/</loc>)(?:<lastmod>.*?</lastmod>)?(</url>)',r'\1<lastmod>2026-09-07</lastmod>\2',sitemap.read_text(encoding='utf-8')),encoding='utf-8')
